#!/usr/bin/python
#Original written By PramitAcharya
...
logo =                                          """            
 ...
 _______  _______          _       ____    ____  _____  _________        _        ______  ____  ____       _       _______   ____  ____     _       
|_   __ \|_   __ \        / \     |_   \  /   _||_   _||  _   _  |      / \     .' ___  ||_   ||   _|     / \     |_   __ \ |_  _||_  _|   / \      
  | |__) | | |__) |      / _ \      |   \/   |    | |  |_/ | | \_|     / _ \   / .'   \_|  | |__| |      / _ \      | |__) |  \ \  / /    / _ \     
  |  ___/  |  __ /      / ___ \     | |\  /| |    | |      | |        / ___ \  | |         |  __  |     / ___ \     |  __ /    \ \/ /    / ___ \    
 _| |_    _| |  \ \_  _/ /   \ \_  _| |_\/_| |_  _| |_    _| |_     _/ /   \ \_\ `.___.'\ _| |  | |_  _/ /   \ \_  _| |  \ \_  _|  |_  _/ /   \ \_  
|_____|  |____| |___||____| |____||_____||_____||_____|  |_____|   |____| |____|`.____ .'|____||____||____| |____||____| |___||______||____| |____| 
...
def sarfraz():   
    ...
    if select =='1':
       ...
       cutter()
        ...
        os.system('xdg-open https://www.facebook.com/pramit.acharya.1?mibextid=ZbWKwL/')
    else:
        print('\n Select valid option ... ')
        time.sleep(2)
        SSB(allkey)
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def pasw(self):       
            ...
            print('')
            if sl =='':
                print('\n Put limit between 1 to 30 KO BICH MA MATRA RAKH')
            elif sl > 20:
                print('\nPassword limit YETI BHANDA DHERAI NARAKH 30')
            else:
                for sr in range(sl):
            ...
            print(f"\r{A}Use Gar hai flight (airplane) mode before use {S}")
            print(47*"-")
